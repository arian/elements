...
$.implement = function(methods){
    for (var name in methods) $.prototype[name] = methods[name]
    return $
}
...
Elements.prototype.handle = function handle(method){
...
Elements.prototype.remove = function(destroy){
